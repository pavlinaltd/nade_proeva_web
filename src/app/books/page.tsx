            ...
            <Table>
                <TableHeader>
                    <TableRow>
                        ...
                        <TableHead className="rounded-tr-md border-r-0">
                            ISBN
                        </TableHead>
                    </TableRow>
                </TableHeader>
            ...
            <div className="animate-fade-in">
                ...
                <div className="my-12 lg:mx-20">
                    ...
                    <p className="text-gray-700 mb-6">
                        Below is an extended listing of books edited or
                        translated by Professor Dr. Nade Proeva as part of her
                        scholarly contribution to ancient Macedonian studies.
                    </p>

                    <BookTable
                        books={books.filter(
                            (book) => book.author !== "Nade Proeva",
                        )}
                    />
                </div>
                ...
                <div className="lg:mx-20">
                    ...
                    <Accordion type="multiple">
                        ...
                        <AccordionItem value="item-2">
                            <AccordionTrigger>
                                Books and Book Translations / Книги и преводи на
                                книги
                            </AccordionTrigger>
                            <AccordionContent>
