      ...
      <div className="lg:mx-[5.5rem] flex flex-col items-center gap-12">
        ...
        <div className="animate-fade-in w-full bg-gray-50 rounded-2xl sm:p-4 md:p-5 flex flex-col md:flex-row items-center gap-10 md:gap-16">
          ...
          <div className="flex-1 flex flex-col items-center gap-5 max-w-xl mx-auto">
            ...
            <p className="text-black text-base leading-relaxed text-justify">
              This volume is a tribute by five former students of Professor Dr.
              Nade Proeva, who came together to honor her legacy. It brings
              together their writings on Macedonian history, spanning
              archaeology, ethnology, anthropology, mythology, and religion from
              antiquity to the present. Through these pages, they celebrate
              their teacher's lasting influence and honor her lifelong devotion
              to truth, scholarship, and her beloved homeland, Macedonia.
            </p>
            <a
        ...
        <div className="flex flex-col lg:flex-row items-center gap-2 -mt-6 self-start lg:self-center">
          ...
          <p className="text-center md:text-left italic text-gray-500">
            * Translations are done by Google Translate and may have errors.
          </p>
        </div>
        {/* Press Wall */}
