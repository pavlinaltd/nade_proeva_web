    ...
    const papers: PaperProps[] = [
        {
            ...
            abstract:
                "This paper explores the connection between the ancient belief in eternal life, as depicted in the myth of Philemon and Baucis, and its reflection in Roman-era funerary practices in Upper Macedonia.",
        },
        {
            ...
            abstract:
                "This paper reviews an exhibition held at the Archaeological Museum in Skopje in 2019, marking the 100th anniversary of the discovery of two gold funeral masks in the Trebeništa necropolis.",
        },
        {
        ...
        },
        {
            ...
            abstract:
                "This paper examines a group of funeral stelae from Upper Macedonia that feature unique motifs like human figures shaped as trees, grapevines, and agricultural tools.",
        },
        {
            ...
            abstract:
                "This paper analyzes the political pressures and blackmail faced by the Republic of Macedonia following its 1991 independence, particularly regarding the dispute over its name. It critiques the role of NATO, the EU, and national myths—especially the revival of ancient Macedonian identity—in shaping the country's international recognition and identity politics.",
        },
        {
            ...
            abstract:
                "The paper is written in honor of and in tribute to Nade Proeva's former student, the late Aleksandar Stojcev, a History Ph.D. specializing in military history.",
        },
        {
            ...
            abstract:
                "A list of events in chronological order regarding Macedonian history between the Iron Age and April 8th, 1993.",
        },
        {
            ...
            abstract:
                "This passage discusses Professor M. Garašanin's analysis of the golden funerary masks from the Trebenište culture, which he attributed to the Engelanes/Encheleis tribe.",
        },
        {
            ...
            abstract:
                "This article investigates the authorship of the Trebenište culture and the gold funeral masks, analyzing archaeological finds and their implications for understanding ancient Macedonian society.",
        },
    ];
    ...
    return (
        <div>
            <SectionHeader
                ...
                subtitle={
                    <>
                        Professor Proeva's scholarly legacy encompasses over
                        fifty academic publications, including articles, book
                        reviews, conference papers, and encyclopedia entries.
                        Many of her works are accessible through academic
                        databases such as academia.edu or by contacting the
                        Department of History at{" "}
                        <i>Ss. Cyril and Methodius University</i> in Skopje,
                        Macedonia. A list of her most popular papers are here.
                    </>
                }
            />
            <div className="animate-fade-in lg:mx-[6rem]">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 justify-between">
                    {papers.map((paper, index) => (
                        <div
                            key={index}
                            className="bg-gray-100 rounded-lg border border-gray-300 p-6 shadow-lg flex flex-col justify-between"
                        >
                            <div>
                            ...
                            <Button
                                ...
                                variant="ghost"
                                size="sm"
                                className="self-endflex items-center gap-2 bg-burgundy-700 hover:bg-burgundy-900 text-white"
                            >
                                <a
                                    href={paper.url}
                                    target="_blank"
