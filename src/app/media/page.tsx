...
export default function Media() {
    ...
    const [playingMobileIdx, setPlayingMobileIdx] = useState<number | null>(
        null,
    );
        ...
        <>
            <div className="text-center lg:mx-20">
                ...
                <section className="animate-fade-in">
                    ...
                    <div className="hidden lg:block">
                        ...
                        <div className="flex justify-center px-3">
                            ...
                            >
                                ...
                                >
                                    <div className="flex gap-3 px-3 items-center overflow-x-auto">
                                        {videos.map((v, i) => (
                                            <button
                                                key={i}
                                                onClick={() =>
                        ...
                        <div className="mt-3 flex justify-center px-3">
                            <div className="bg-[#cdcfd1] rounded px-3 py-3 w-full max-w-6xl">
                                <div className="text-[9px] text-[#000000] tracking-[2px] uppercase font-mono mb-1">
                                    V —{" "}
                                    {String(activeVideoIdx + 1).padStart(
                                        3,
                                        "0",
                                    )}
                                    {selectedVideo.year
                    ...
                    <div className="lg:hidden flex flex-col gap-10 px-6 pt-5">
                        {videos.map((v, i) => (
                            <div
                                key={i}
                                className="bg-[#cdcfd1] rounded-sm p-3"
                            >
                                {/* title */}
                ...
                <section className="animate-fade-in">
                    ...
                    <div className="hidden lg:block">
                        {/* scroll */}
                        <div className="hidden [@media(min-width:1024px)_and_(max-width:1270px)]:flex items-center gap-3 px-3 mb-5 ">
                            <div className="flex-1 h-px bg-[#8B1A1A]" />
                            <span className="text-[10px] text-[#8B1A1A] font-mono">
                                scroll →
                            </span>
