...
export default function Press() {
    ...
    const columns: MediaItem[] = [
        ...
        },
        {
            ...
            pageImagesOriginal: ["/images/columns/eden.jpg"],
            pageImagesEnglish: ["/images/columns/eden-eng.jpg"],
            orientation: "vertical",
            titlePosition: "left",
        },
        {
        ...
        // HORIZONTAL
        {
            ...
            pageImagesOriginal: ["/images/columns/bugarskoto.jpg"],
            pageImagesEnglish: ["/images/columns/bugarskoto-eng.jpg"],
            orientation: "horizontal",
            titlePosition: "left",
        },
        {
            title: "Бугарска койија на грчкото однесување",
            pageImagesOriginal: ["/images/columns/bugarska.jpg"],
            pageImagesEnglish: ["/images/columns/bugarska-eng.jpg"],
            orientation: "horizontal",
            titlePosition: "left",
        },
        {
            title: "Историјата можат да ја одбранаш само историчарите",
            pageImagesOriginal: ["/images/columns/istoriyata.jpg"],
            pageImagesEnglish: ["/images/columns/istoriyata-eng.jpg"],
            orientation: "horizontal",
            titlePosition: "center",
        },
        {
            title: "Француска цивилизациска утка на отворањето на ЛОИ",
            pageImagesOriginal: ["/images/columns/fran.jpg"],
            pageImagesEnglish: ["/images/columns/fran-eng.jpg"],
            orientation: "horizontal",
            titlePosition: "center",
        },
        {
            title: "Институционализирање на неинституционалното",
            pageImagesOriginal: ["/images/columns/instit.jpg"],
            pageImagesEnglish: ["/images/columns/instit-eng.jpg"],
            orientation: "horizontal",
            titlePosition: "left",
        },
        {
            title: "Кога политичарите решаваат научни проблеми",
            pageImagesOriginal: ["/images/columns/koga.jpg"],
            pageImagesEnglish: ["/images/columns/koga-eng.jpg"],
            orientation: "horizontal",
            titlePosition: "left",
        },
        {
            title: "Европското лицемерие и нашите мекотели",
            pageImagesOriginal: ["/images/columns/evropskoto.jpg"],
            pageImagesEnglish: ["/images/columns/evropskoto-eng.jpg"],
            orientation: "horizontal",
            titlePosition: "center",
        },
        {
            title: "Бушкај штреба да ја бијат йолитичарите",
            pageImagesOriginal: ["/images/columns/bushkai.jpg"],
            pageImagesEnglish: ["/images/columns/bushkai-eng.jpg"],
            orientation: "horizontal",
            titlePosition: "left",
        },
        {
            title: "За сонцето не се преговара, господа политичари и историчари",
            pageImagesOriginal: ["/images/columns/za-sontseto.jpg"],
            pageImagesEnglish: ["/images/columns/za-sontseto-eng.jpg"],
            orientation: "horizontal",
            titlePosition: "left",
        },
        {
            title: "Националните митови што оживуваат денес се лажни и штетни",
            pageImagesOriginal: ["/images/columns/natsionalnite.jpg"],
            pageImagesEnglish: ["/images/columns/natsionalnite-eng.jpg"],
            orientation: "horizontal",
            titlePosition: "left",
        },
    ];
                        ...
                        >
                            <div
                                className={
                                    ...
                                    "h-full md:h-[150px] lg:h-[250px] xl:h-[150px]"
                                }
                            >
                                <img
                                    src={
                                        isEnglish
                                            ? col.pageImagesEnglish?.[0] ||
                                              col.pageImagesOriginal?.[0]
                                            : col.pageImagesOriginal?.[0]
                                    }
                                    alt={col.title}
                                    className={
                                        col.orientation === "vertical"
                                            ? "object-scale-down"
                                            : "w-full object-scale-down object-top"
                                    }
                                />
                                <span
                        ...
                        <Carousel
                            className={
                                selectedImage.orientation === "vertical"
                                    ? "w-[700px] bg-white rounded-sm"
                                    : "w-[1000px] bg-white rounded-sm relative"
                            }
                        >
                            <CarouselContent>
                                {isEnglish && selectedImage.pageImagesEnglish
                                    ? selectedImage.pageImagesEnglish?.map(
                                          (image, index) => (
                                              <div
                                                  key={index}
                                    ...
                                    : selectedImage.pageImagesOriginal?.map(
                                          (image, index) => (
                                              <div
                                                  key={index}
                                                  className="flex-shrink-0 w-full h-auto"
