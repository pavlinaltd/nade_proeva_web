  ...
  return (
    <>
      <div className="camp-modal">
        {/* Poster */}
        <div className="camp-modal-image" onClick={() => setMobileOpen(true)}>
          <img src="/images/summer_camp/camp27.jpg" alt="Summer Camp Poster" />
        ...
        >
          ...
          <div className="camp-desc">
            <span className="camp-desc-block">
              On the shores of Lake Prespa—one of Europe's ancient waters—this
              initiative opens history as a living field of discovery, identity,
              <br></br> and thought.
            </span>
            <span className="camp-desc-block">
              Through work with sources, methods, and themes from ancient to
              modern history, this annual educational program fosters curiosity
              and analytical skills. Named in honor of Professor Dr. Nade
              Proeva, the camp continues her legacy of historical scholarship
          ...
          {/* Form */}
          <form ref={formRef} onSubmit={handleSubmit} className="camp-form">
